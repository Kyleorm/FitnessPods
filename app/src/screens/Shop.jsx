...
const bundles = [
  ...
  { pts: 5,  bonus: 1, price: 28,  tag: null,           giftFriendly: false },
  { pts: 9,  bonus: 2, price: 49,  tag: 'Most Popular', giftFriendly: false },
  { pts: 20, bonus: 5, price: 105, tag: 'Best Value',   giftFriendly: false },
];
    ...
    <div className="screen">
      ...
      <div style={s.body}>
        ...
        <div style={s.toggle} className="fade-up">
          ...
          <button
            style={{ ...s.toggleBtn, ...(mode === 'gift' ? s.toggleBtnActive : {}) }}
          ...
          <div style={s.bundleList}>
            {bundles.map((b, i) => (
              ...
              >
                ...
                {/* Check */}
                <div style={{ ...s.check, ...(selected === i ? s.checkActive : {}) }}>
                  {selected === i && (
        ...
        {/* CTA */}
        <div style={s.ctaBar} className="fade-up fade-up-3">
          <div>
